  ...
  if(!isOpen) {
    return (
      <button onClick={handleToggleModal}
              ...
              >
                <img src="src/assets/open_in_new_32dp_FFF_FILL0_wght400_GRAD0_opsz40.png" alt="open" />
          </button>
    )
  }
      ...
      <div className="relative pt-8 w-96 border bg-gradient-to-b from-black to-purple-800 p-4 rounded-lg shadow-md">
        ...
        <div>
          <h1 className="text-1xl text-white mb-6 font-extralight">Dom Bot</h1>
            ...
            <Weather weatherData={weatherData} setWeatherData={setWeatherData} weatherImage={weatherImage} setWeatherImage={setWeatherImage}/>
